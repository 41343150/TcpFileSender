...
this, SLOT (updateServerProgress()));//連接readyRead()訊號至updateServer Progress()槽函數
...
void TcpFileSender::updateServerProgress()
{
...
void TcpFileSender::displayError (QAbstractSocket:: SocketError socketError)
{
